...
void init_uart(uint32_t baud_rate){
	...
	//hay que conectar el pin de la UART0 al puerto correspondiente
	
	SIM->SCGC5 |= SIM_SCGC5_PORTA_MASK;
	
	//antes de configurar nada de la UART0 hay que deshabilitarla
...
//vamos a configurar transmisiones de 8 bits sin bit de paridad
